    ...
    return (
        <div className="w-full max-w-7xl mx-auto animate-fade-in">
            <header className="mb-6 md:mb-8">
                <div>
                    <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent">Resource Hub</h2>
