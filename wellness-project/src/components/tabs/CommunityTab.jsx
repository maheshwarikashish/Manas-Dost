    ...
    return (
        <div>
            <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
                ...
                <h3 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Peer Support Community</h3>
